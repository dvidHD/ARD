const int joyLR = A1;     //Declaramos el puerto analogico en el que conectaremos la señal del potenciometro "L/R" del Joystick  
const int joyUD = A0;    //Declaramos el puerto analogico en el que conectaremos la señal del potenciometro "U/D" del Joystick
const int joyZ=9;
