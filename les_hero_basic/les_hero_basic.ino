...
void setup() {
  // mode the pins,  each to one of them 5-9  4-10   3-11  2-12
  pinMode(2,INPUT);
  pinMode(3,INPUT);
  pinMode(4,INPUT);
  pinMode(5,INPUT);
  ...
  Serial.begin(9600);
  Serial.println("+---------------------------------------------------------------+");
  Serial.println("|Bienvenido a Led Hero!                                         |");
  Serial.println("|Cuando se encienda un led, presiona el boton correspondiente   |");
  Serial.println("|Pierdes vidas cuando tardas mucho o presionas mal un boton     |");
  Serial.println("|presiona cualqueir boton para iniciar...                       |");
  Serial.print("+---------------------------------------------------------------+");
}
...
void loop() {
  ...
  if (started==true){
    ...
    if(updateScreen==true){
      ...
      Serial.println("|                                                               |");
      Serial.print("| Score: ");
      Serial.print(score);  // here we print the NEW score
      if(score<10){
        Serial.println("                                                      |");
      }
      else if(score<100){
